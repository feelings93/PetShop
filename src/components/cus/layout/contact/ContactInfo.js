    ...
    <Box>
      <Box mb={2}>
        ...
        <div data-aos="fade-up" data-aos-duration={900}>
          ...
          Theo dõi những gì đang xảy ra với dữ liệu của bạn, thay đổi quyền và chạy báo cáo dựa trên dữ liệu của bạn ở mọi nơi trên thế giới. Theo dõi những gì đang xảy ra với dữ liệu của bạn, thay đổi quyền.
          </Typography>
        </div>
      </Box>
      <Box
